...
type
  TFormMainMenu = class(TForm)
    ...
    procedure SpeedButtonComprasClick(Sender: TObject);
...
procedure TFormMainMenu.Altadecompras1Click(Sender: TObject);
begin
  TFormCatalogoCompras.Create(Self).Show;
end;
...
procedure TFormMainMenu.Conceptosdemovimientosalinventario1Click(
  Sender: TObject);
begin
    FormConceptos.Show;
end;
...
procedure TFormMainMenu.Ctalogodeproveedores1Click(Sender: TObject);
begin
...
procedure TFormMainMenu.Usuarios1Click(Sender: TObject);
begin
  FormUsuarios.Show;
