          ...
          Begin
            ...
            With DataModule1.FDQueryfolios do
             Begin
               ...
               ExecSQL;
               ShowMessage('Compra guardada éxitosamente');
             End;
...
begin
      Save:=Application.MessageBox('¿Desea Salir del registro de compra?','¡Confirmando!',MB_YESNO);
        Begin
         if Save=IDYES then
           Begin
              With FDQueryDetalleCompra do  //borra partidas
               Begin
                 Sql.Clear;
              ...
              With DataModule1.FDQueryMovimientosInv do  //bora partidas
               Begin
                 Sql.Clear;
                 Sql.Add('Delete from "CMSoftware"."MovimientosInventario" where num_docto=:param1');
                 Params[0].AsString:=EditNumeroCompra.Text;
                 ExecSQL;
               End;
